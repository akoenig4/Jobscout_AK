...
queue_url = 'https://sqs.us-east-2.amazonaws.com/767397805190/QueryJobsDB'  # Replace with your actual SQS Queue URL
...
if st.button("search"):
    if job_title or location or company:  # Ensure all fields are filled out
        try:
            # Send message to SQS
